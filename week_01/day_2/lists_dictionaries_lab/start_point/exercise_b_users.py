...
# can create variable first for April specifically but not needed
# need to create an empty list and then add into the list following the loop

even_numbers = []
for num in users["April"]["lottery_numbers"]:
  if num % 2 == 0:
